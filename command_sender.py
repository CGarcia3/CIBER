...
def init_argparse() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--host", action="store", help="Dirección IP:puerto del componente")
    parser.add_argument("--no_response", action="store_true", help="No espera por una respuesta (ACK)")
    parser.add_argument('mensaje', nargs='*', type=str, help="Tipo de mensaje (LINK, FLY, etc.)")
    return parser
